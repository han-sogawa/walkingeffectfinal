...
public class AddLocationPanel extends JPanel{
  ...
  public AddLocationPanel(Map map){
    ...
    try {
      ...
      customFont = Font.createFont(Font.TRUETYPE_FONT, new File("fontBold.ttf")).deriveFont(20f);
      keyFont = Font.createFont(Font.TRUETYPE_FONT, new File("fontBold.ttf")).deriveFont(17f);
