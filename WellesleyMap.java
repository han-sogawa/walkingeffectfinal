...
public class WellesleyMap extends Map{
  public WellesleyMap(){
    //Create locations for Wellesley Map: Location(name, about, picture file)
    Location ksc = new Location("(1) Sports Center", "Nannerl O. Keohane Sports Center, named for Nannerl" 
                   ...
                   + "wellness activities for the entire College community.", "images/pic1ksc.jpg");
    Location resQ = new Location("(2) Res Quad", "The Quad is made up of four dorms: Beebe, Cazenove, Pomeroy, "
                   + "and Shafer Halls. The halls in the Quad are known for their convenient location and " 
                   + "fun atmosphere. One of the trickiest things about the Quad can be simply remembering which "
                   + "building is which - so something helpful to keep in mind is that the halls are in" 
                                   + "alphabetical order.", "images/pic2resQ.jpg");
    Location alum = new Location("(3) Alumnae Hall", "The Diana Chapman Walsh Alumnae Hall houses the Theatre "
                   + "Studies Department, a 1300-seat auditorium, a black box theatre, and a ballroom for dance" 
                   +"rehearsals, parties, and aerobics. "
                   + "Many campus performances and events are held here.", "images/pic3alum.jpg");
    Location lulu = new Location("(4) Lulu", "The Lulu Chow Wang Campus Center, with its labyrinth-like layout and "
                   + "unexpected open spaces, provides an inviting place where members of the Wellesley community can "
                   + "gather for impromptu conversation or more formal meetings of the College's 160 student "
                   + "organizations and College Government. The 'Lulu' houses a bookstore, dining area and coffee bar,"
                   + " cafe and pub, large multipurpose spaces for performances and social functions,"
                   + "and meeting rooms.", "images/pic4lulu.jpg");
    Location acaQ = new Location("(5) Acad Quad", "Pendleton Hall, Founders Hall, and the Jewett Arts Center make up "
                    + "the heart of the Academic Quad, where most of Wellesley's classes, except for "
                    + "the sciences, meet. These three buildings house all of the social science, art,"
                    + "and humanities departments.", "images/pic5acaQ.jpg");
    Location sciCen = new Location("(6) Science Center", "The Science Center comprises four buildings: the Margaret "
                    + "Fergusson Greenhouses; Sage Hall; the Laboratory Wing; and the E-wing.  The Science Center "
                    + "serves as the home of Science, Technology, Engineering, and Mathematics at Wellesley College, "
                    + "and houses all the science departments and programs offered at the College.",
                                   "images/pic6sciCen.jpg");
    Location twr = new Location("(7) Tower Court", "Made up of Tower Court and Severance and Claflin Halls, the Tower "
                    + "Complex is generally considered to contain some of the more social dorms on campus (which isn't "
                    + "to say, of course, that all the dorms aren't social, in their own ways - but there does tend to "
                    + "be a little more noise and activity in the hallways in these dorms). And of course, the halls "
                    + "that make up Tower Court are some of the most beautiful buildings on campus. Given its lovely "
                    + "courtyard, lake views, and Elizabethan Gothic and Georgian-style architecture, it's no wonder "
                    + "that Tower Court is the dorm that you probably saw the most pictures of in"
                    +"the Admissions literature!", "images/pic7twr.jpg");
    Location lib = new Location("(8) Library", "Named for Wellesley's eighth president, the Margaret Clapp Library "
                    + "is the centerpiece of the College library system, which contains over a million volumes. "
    ...
    Location east = new Location("(10) East Campus Dorms", "The East Campus residential complex is usually "
                   + "referred to as the 'New Dorms' - although, that's sort of a misnomer, given that they "
                   + "were built in the 1950s and 60s. The residence halls that make up the New Dorms are Freeman,"
                   + " Bates, and McAfee. Though the New Dorms are more box-like than castle-like in terms of"
                   + " architecture, they more than make up for that with the size of their rooms, which are "
                   + "by and large bigger than in any other dorm.", "images/pic10east.jpg");                
    ...
    //(8)Lib will go to Lulu(above), AcaQ(above), SciCen(above), Twr(above), and Stone
    ...
    //(10)East will go to AcaQ(above), SciCen(above), and Stone(above)
